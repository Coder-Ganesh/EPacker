...
namespace ePacker1
{
    public partial class RPeP_PartyBuyer : Form
    {
        ...
        private void RPeP_PartyBuyer_Load(object sender, EventArgs e)
        {
            ...
            con1.Open();
            SqlDataAdapter da2 = new SqlDataAdapter("SELECT '' as P_ID, '' as P_Name UNION select  a.P_ID, a.P_Name +' ( '+ b.PM_Name +')'  as Name from Party_Master a, PartyMain_Master b where a.PM_ID = b.PM_ID and a.P_Active='Yes'", con1);
            ...
            ddlPB_Active.SelectedText = "Yes";
            ddlPB_Active.Enabled = false;
            ddlPB_Active.Items.Add("Yes");
            ddlPB_Active.Items.Add("No");
        ...
        private void ddlGrp_ID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //string ddlpid = ddlP_ID.SelectedValue.ToString();
        ...
        private void filldata()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter(" select c.PB_ID, (d.Grp_SName +' ('+ d.Grp_Name +')') as Grp_Data, a.P_Name +' ( '+ b.PM_Name +')'  as Party,c.PB_Name as Buyer,c.PB_Phone as TelePhone,c.PB_Mobile as Mobile,c.PB_Email as Email,c.PB_Active as Active from Party_Master a, PartyMain_Master b,Party_Buyer as c,Group_Master as d  where  a.PM_ID = b.PM_ID and a.P_ID=c.P_ID and  c.Grp_ID=d.Grp_ID and a.P_Active='Yes' order by a.P_Name, c.PB_Name", con4);
        ...
        private void dgwPartyBuyer_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            //ddlGrp_ID.Text = dgwPartyBuyer.Rows[e.RowIndex].Cells[1].Value.ToString();
        ...
        private void cmd_PB_Name_Search_Click(object sender, EventArgs e)
        {
            ...
            string strcon = funclib.setConnection();
            SqlConnection con = new SqlConnection(strcon);
            //SqlDataAdapter da = new SqlDataAdapter("Select * from Party_Buyer where P_ID = '" + ddlP_ID_Search.SelectedValue.ToString() + "' AND PB_Name like '%"+ txtPB_Name_Search.Text+ "%' order by P_Name, PB_Name", con);

            SqlDataAdapter da = new SqlDataAdapter(" select c.PB_ID, (d.Grp_SName +' ('+ d.Grp_Name +')') as Grp_Data, a.P_Name +' ( '+ b.PM_Name +')'  as Party,c.PB_Name as Buyer,c.PB_Phone as TelePhone,c.PB_Mobile as Mobile,c.PB_Email as Email,c.PB_Active as Active from Party_Master a, PartyMain_Master b,Party_Buyer as c,Group_Master as d  where PB_Name like '%" + txtPB_Name_Search.Text + "%' and  c.P_ID='" + ddlP_ID_Search.SelectedValue.ToString() + "' and  a.PM_ID = b.PM_ID and a.P_ID=c.P_ID and  c.Grp_ID=d.Grp_ID and a.P_Active='Yes' order by a.P_Name, c.PB_Name", con);
        ...
        private void cmdExcelReport_Click(object sender, EventArgs e)
        {
            ...
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                ...
                strSQL = strSQL + " select  (d.Grp_SName +' ('+ d.Grp_Name +')') as Grp_Data, a.P_Name +' ( '+ b.PM_Name +')'  as Party,c.PB_Name as Buyer,c.PB_Phone as TelePhone,c.PB_Mobile as Mobile,c.PB_Email as Email,c.PB_Active as Active from Party_Master a, PartyMain_Master b,Party_Buyer as c,Group_Master as d  where PB_Name like '%" + txtPB_Name_Search.Text + "%' and  c.P_ID='" + ddlP_ID_Search.SelectedValue.ToString() + "' and  a.PM_ID = b.PM_ID and a.P_ID=c.P_ID and  c.Grp_ID=d.Grp_ID and a.P_Active='Yes' order by a.P_Name, c.PB_Name";
