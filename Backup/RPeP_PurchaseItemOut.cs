...
namespace ePacker1
{
    public partial class PurchaseItemOut : Form
    {
        ...
        public PurchaseItemOut()
        {
            ...
            //stripAssress = he.AddressList[0].ToString(); // returns IP address
        ...
        private void PurchaseItemOut_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("SELECT '' as SI_ID, '' as SI_Name UNION select SI_ID,SI_Name from Purchase_Item where SI_Active='Yes' and SI_ID not in (select SI_ID from Purchase_ItemIn_Det_Temp where Add_By='" + session + "')", con1);
        ...
        private void cmdSubmit_Click(object sender, EventArgs e)
        {
            ...
            //}
            //else if (ddlSI_ID.Text == "")//Checking for blnk PinCode field
            //{
            //    MessageBox.Show("Please Select Purchase Item");
            //    ddlSI_ID.Focus();
            //}
            if (txtSIOut_Dt.Text == "")//Checking for blnk Mobile field
            {
        ...
        private void cmdTemp_Submit_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(strcon1);
             ...
             if (ddlSI_ID.Text == "")//Checking for blnk PinCode field
            {
                MessageBox.Show("Please Select Purchase Item");
                ddlSI_ID.Focus();
            }
